...
namespace seems
{
    ...
    public class PeptideFragmentationAnnotation : AnnotationBase
    {
        ...
        bool showBasophileModel;
        //test neutral loss
        bool waterLoss;
        bool ammoniumLoss;
        bool phosphateLoss;
        bool basePeakThresholding;

        int numPhosphate;
        double basePeakPercentage;

        double WATERMONOMASS = 18.01056;
        double AMMONIUMMONOMASS = 17.02654;
        double PHOSPHATEMONOMASS = 97.9769;
        ...
        public PeptideFragmentationAnnotation()
        {
            ...
            annotationPanels.phosphateUpDown.ValueChanged += new EventHandler(checkBox_CheckedChanged);
        ...
        public override Panel OptionsPanel
        {
            get
            {
                ...
                //added and checked, found no problem
                annotationPanels.showFragmentationSummaryCheckBox.Checked = showFragmentationSummary;
                annotationPanels.showBasophileCheckBox.Checked = showBasophileModel;
